...
from evaluate import add_noise, randomly_mask_S
...
def main():
    ...
    results_dir = f"results/{network}_mask/run_{CONFIG['run_id']}"
    ...
    # S = add_noise(S, noise_level=noise_level)

    dropout_rate = 0.1  # Drop 20% of measurements
    S = randomly_mask_S(S, dropout_rate=dropout_rate)
